...
inline int compare_meeting(const void *meeting0, const void *meeting1)
{
...
inline void print_calendar(Meeting *calendar, int num)
{
...
inline int check_timeslot(Meeting *calendar, int num, Meeting newmeeting)
{
	for (int i = 0; i < num; i++) {
...
inline int file_line_count(const char *filename)
{
...
inline int validate_date(MeetingDate date)
{
...
inline Meeting *add_meeting(Meeting *calendar, int num, Meeting newmeeting)
{
...
inline Meeting *delete_meeting(Meeting *calendar, int num, MeetingDate timeslot)
{
...
inline int write_calendar(Meeting *calendar, int num, const char *filename)
{
	char buffer[1000];
...
inline Meeting *load_calendar(const char *filename)
{
	char buffer[1000];
	FILE *file_ptr = fopen(filename, "r");
	if (!file_ptr)
